...
const TypeEvent_schema_1 = require("../schemas/TypeEvent.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: TypeEvent_schema_1.TypeEvent.name, schema: TypeEvent_schema_1.TypeEventSchema },
            ]),
        ],
        providers: [type_event_service_1.TypeEventService],
        exports: [type_event_service_1.TypeEventService],
    })
], TypeEventModule);
